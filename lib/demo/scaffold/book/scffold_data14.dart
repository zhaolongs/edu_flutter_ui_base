...
class FirstThemState extends State<FirstPage> {
  ...
  ///3.5.1 BottomAppBar结合悬浮按钮使用 Scaffold中的配置
  @override
  ...
  Widget buildBodyFunction(){
   ...
   return Stack(children: <Widget>[
     ...
     Opacity(opacity: _tabIndex==3?1:0,child: ScffoldHomeItemPage(2),),

   ],);
  }

  ///3.5.1 BottomAppBar结合悬浮按钮使用 BottomAppBar的配置
    ...
    return BottomAppBar(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          buildBotomItem( -1, null, "添加"),
          buildBotomItem( 2, Icons.people, "发现"),
